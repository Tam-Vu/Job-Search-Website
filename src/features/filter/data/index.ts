...
//     jobField: "it",
//   },
//   { key: "residential_agent", name: "Nhân viên bất động sản nhà ở", jobs: "real_estate_agent", jobField: "real_estate_construction" },
//   { key: "commercial_agent", name: "Nhân viên bất động sản thương mại", jobs: "real_estate_agent", jobField: "real_estate_construction" },
//   { key: "real_estate_investor", name: "Nhà đầu tư bất động sản", jobs: "real_estate_agent", jobField: "real_estate_construction" },
//   { key: "property_manager", name: "Quản lý bất động sản", jobs: "real_estate_agent", jobField: "real_estate_construction" },
//   // Real Estate/Construction
//   {
//     key: "construction_manager",
//     name: "Quản lý xây dựng",
//     jobs: "construction_manager",
...
//     jobs: "real_estate_agent",
//     jobField: "real_estate_construction",
//   },
//   {
//     key: "property_manager",
//     name: "Quản lý tài sản",
//     jobs: "property_manager",
//     jobField: "real_estate_construction",
//   },
//   {
//     key: "broker",
...
//     jobs: "customer_service_representative",
//     jobField: "retail_life_services",
//   },
//   {
//     key: "personal_shopper",
//     name: "Tư vấn mua sắm cá nhân",
//     jobs: "personal_shopper",
//     jobField: "retail_life_services",
//   },
//   {
//     key: "retail_analyst",
...
//     jobs: "marketing_specialist",
//     jobField: "retail_life_services",
//   },
//   {
//     key: "product_placement_specialist",
//     name: "Chuyên gia trưng bày sản phẩm",
//     jobs: "product_placement_specialist",
//     jobField: "retail_life_services",
//   },
// ]

export const professionalPosition = [
  { key: "software_dev", name: "Lập trình viên phần mềm", jobs: "software", jobField: "it" },
  { key: "software_architect", name: "Kiến trúc sư phần mềm", jobs: "software", jobField: "it" },
  { key: "software_tester", name: "Kiểm thử phần mềm", jobs: "software", jobField: "it" },
  { key: "software_support", name: "Hỗ trợ phần mềm", jobs: "software", jobField: "it" },
  { key: "qa_engineer", name: "Kỹ sư QA", jobs: "testing", jobField: "it" },
  { key: "automation_tester", name: "Kiểm thử tự động", jobs: "testing", jobField: "it" },
  { key: "manual_tester", name: "Kiểm thử thủ công", jobs: "testing", jobField: "it" },
  { key: "performance_tester", name: "Kiểm thử hiệu suất", jobs: "testing", jobField: "it" },
  { key: "inside_sales", name: "Nhân viên bán hàng nội bộ", jobs: "sales_rep", jobField: "business_sales" },
  { key: "outside_sales", name: "Nhân viên bán hàng ngoại tuyến", jobs: "sales_rep", jobField: "business_sales" },
  { key: "sales_closer", name: "Nhân viên chốt đơn", jobs: "sales_rep", jobField: "business_sales" },
  { key: "sales_consultant", name: "Tư vấn bán hàng", jobs: "sales_rep", jobField: "business_sales" },
  { key: "regional_sales_manager", name: "Quản lý bán hàng khu vực", jobs: "sales_manager", jobField: "business_sales" },
  { key: "national_sales_manager", name: "Quản lý bán hàng quốc gia", jobs: "sales_manager", jobField: "business_sales" },
  { key: "sales_operations_manager", name: "Quản lý vận hành bán hàng", jobs: "sales_manager", jobField: "business_sales" },
  { key: "sales_strategy_manager", name: "Quản lý chiến lược bán hàng", jobs: "sales_manager", jobField: "business_sales" },
  { key: "seo_specialist", name: "Chuyên viên SEO", jobs: "digital_marketing", jobField: "marketing_pr_advertising" },
  { key: "content_marketer", name: "Chuyên viên nội dung", jobs: "digital_marketing", jobField: "marketing_pr_advertising" },
  { key: "email_marketer", name: "Chuyên viên tiếp thị qua email", jobs: "digital_marketing", jobField: "marketing_pr_advertising" },
  { key: "ppc_specialist", name: "Chuyên viên PPC", jobs: "digital_marketing", jobField: "marketing_pr_advertising" },
  { key: "media_relations", name: "Quan hệ truyền thông", jobs: "pr_specialist", jobField: "marketing_pr_advertising" },
  { key: "crisis_communication", name: "Giao tiếp khủng hoảng", jobs: "pr_specialist", jobField: "marketing_pr_advertising" },
  { key: "event_pr", name: "PR sự kiện", jobs: "pr_specialist", jobField: "marketing_pr_advertising" },
  { key: "internal_communication", name: "Giao tiếp nội bộ", jobs: "pr_specialist", jobField: "marketing_pr_advertising" },
  { key: "customer_support_agent", name: "Nhân viên hỗ trợ khách hàng", jobs: "customer_service_rep", jobField: "customer_service_operations" },
  { key: "technical_support_agent", name: "Nhân viên hỗ trợ kỹ thuật", jobs: "customer_service_rep", jobField: "customer_service_operations" },
  { key: "customer_service_supervisor", name: "Giám sát dịch vụ khách hàng", jobs: "customer_service_rep", jobField: "customer_service_operations" },
  { key: "customer_feedback_specialist", name: "Chuyên viên phản hồi khách hàng", jobs: "customer_service_rep", jobField: "customer_service_operations" },
  { key: "inbound_agent", name: "Nhân viên gọi đến", jobs: "call_center_agent", jobField: "customer_service_operations" },
  { key: "outbound_agent", name: "Nhân viên gọi đi", jobs: "call_center_agent", jobField: "customer_service_operations" },
  { key: "call_center_supervisor", name: "Giám sát viên trung tâm cuộc gọi", jobs: "call_center_agent", jobField: "customer_service_operations" },
  { key: "call_center_trainer", name: "Đào tạo viên trung tâm cuộc gọi", jobs: "call_center_agent", jobField: "customer_service_operations" },
  { key: "residential_agent", name: "Nhân viên bất động sản nhà ở", jobs: "real_estate_agent", jobField: "real_estate_construction" },
  { key: "commercial_agent", name: "Nhân viên bất động sản thương mại", jobs: "real_estate_agent", jobField: "real_estate_construction" },
  { key: "real_estate_investor", name: "Nhà đầu tư bất động sản", jobs: "real_estate_agent", jobField: "real_estate_construction" },
  { key: "property_manager", name: "Quản lý bất động sản", jobs: "real_estate_agent", jobField: "real_estate_construction" },
  { key: "project_manager", name: "Quản lý dự án", jobs: "construction_manager", jobField: "real_estate_construction" },
  { key: "site_manager", name: "Giám đốc công trường", jobs: "construction_manager", jobField: "real_estate_construction" },
  { key: "construction_supervisor", name: "Giám sát xây dựng", jobs: "construction_manager", jobField: "real_estate_construction" },
  { key: "safety_officer", name: "Nhân viên an toàn xây dựng", jobs: "construction_manager", jobField: "real_estate_construction" },
  { key: "structural_engineer", name: "Kỹ sư kết cấu", jobs: "civil_engineer", jobField: "real_estate_construction" },
  { key: "geotechnical_engineer", name: "Kỹ sư địa kỹ thuật", jobs: "civil_engineer", jobField: "real_estate_construction" },
  { key: "transportation_engineer", name: "Kỹ sư giao thông", jobs: "civil_engineer", jobField: "real_estate_construction" },
  { key: "environmental_engineer", name: "Kỹ sư môi trường", jobs: "civil_engineer", jobField: "real_estate_construction" },
  { key: "general_practitioner", name: "Bác sĩ đa khoa", jobs: "doctor", jobField: "healthcare" },
  { key: "surgeon", name: "Bác sĩ phẫu thuật", jobs: "doctor", jobField: "healthcare" },
  { key: "pediatrician", name: "Bác sĩ nhi khoa", jobs: "doctor", jobField: "healthcare" },
  { key: "psychiatrist", name: "Bác sĩ tâm thần", jobs: "doctor", jobField: "healthcare" },
  { key: "registered_nurse", name: "Y tá đã đăng ký", jobs: "nurse", jobField: "healthcare" },
  { key: "nurse_practitioner", name: "Y tá thực hành", jobs: "nurse", jobField: "healthcare" },
  { key: "clinical_nurse", name: "Y tá lâm sàng", jobs: "nurse", jobField: "healthcare" },
  { key: "nurse_manager", name: "Quản lý y tá", jobs: "nurse", jobField: "healthcare" },
  { key: "community_pharmacist", name: "Dược sĩ cộng đồng", jobs: "pharmacist", jobField: "healthcare" },
  { key: "hospital_pharmacist", name: "Dược sĩ bệnh viện", jobs: "pharmacist", jobField: "healthcare" },
  { key: "pharmaceutical_researcher", name: "Nhà nghiên cứu dược phẩm", jobs: "pharmacist", jobField: "healthcare" },
  { key: "clinical_pharmacist", name: "Dược sĩ lâm sàng", jobs: "pharmacist", jobField: "healthcare" },
  { key: "elementary_teacher", name: "Giáo viên tiểu học", jobs: "teacher", jobField: "education" },
  { key: "high_school_teacher", name: "Giáo viên trung học", jobs: "teacher", jobField: "education" },
  { key: "college_professor", name: "Giáo sư đại học", jobs: "teacher", jobField: "education" },
  { key: "special_education_teacher", name: "Giáo viên giáo dục đặc biệt", jobs: "teacher", jobField: "education" },
  { key: "school_principal", name: "Hiệu trưởng", jobs: "administrator", jobField: "education" },
  { key: "district_superintendent", name: "Giám đốc khu học chánh", jobs: "administrator", jobField: "education" },
  { key: "academic_advisor", name: "Cố vấn học thuật", jobs: "administrator", jobField: "education" },
  { key: "curriculum_coordinator", name: "Điều phối viên chương trình giảng dạy", jobs: "administrator", jobField: "education" },
  { key: "front_office_manager", name: "Quản lý lễ tân", jobs: "hotel_manager", jobField: "hospitality_service" },
  { key: "housekeeping_manager", name: "Quản lý bộ phận dọn phòng", jobs: "hotel_manager", jobField: "hospitality_service" },
  { key: "food_beverage_manager", name: "Quản lý thực phẩm và đồ uống", jobs: "hotel_manager", jobField: "hospitality_service" },
  { key: "event_manager", name: "Quản lý sự kiện", jobs: "hotel_manager", jobField: "hospitality_service" },
  { key: "floor_manager", name: "Quản lý sàn", jobs: "restaurant_manager", jobField: "hospitality_service" },
  { key: "kitchen_manager", name: "Quản lý bếp", jobs: "restaurant_manager", jobField: "hospitality_service" },
  { key: "bar_manager", name: "Quản lý quầy bar", jobs: "restaurant_manager", jobField: "hospitality_service" },
  { key: "catering_manager", name: "Quản lý dịch vụ ăn uống", jobs: "restaurant_manager", jobField: "hospitality_service" },
  { key: "design_engineer", name: "Kỹ sư thiết kế", jobs: "mechanical_engineer", jobField: "engineering" },
  { key: "manufacturing_engineer", name: "Kỹ sư sản xuất", jobs: "mechanical_engineer", jobField: "engineering" },
  { key: "quality_engineer", name: "Kỹ sư chất lượng", jobs: "mechanical_engineer", jobField: "engineering" },
  { key: "project_engineer", name: "Kỹ sư dự án", jobs: "mechanical_engineer", jobField: "engineering" },
  { key: "power_engineer", name: "Kỹ sư điện lực", jobs: "electrical_engineer", jobField: "engineering" },
  { key: "control_engineer", name: "Kỹ sư điều khiển", jobs: "electrical_engineer", jobField: "engineering" },
  { key: "electronics_engineer", name: "Kỹ sư điện tử", jobs: "electrical_engineer", jobField: "engineering" },
  { key: "field_engineer", name: "Kỹ sư hiện trường", jobs: "electrical_engineer", jobField: "engineering" },
]