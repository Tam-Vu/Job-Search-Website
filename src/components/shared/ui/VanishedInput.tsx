...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        "relative mx-auto h-[52px] w-full overflow-hidden rounded-full bg-black shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-1000 dark:bg-zinc-800",
        value && "bg-gray-50",
      )}
    ...
    >
      ...
      >
        ...
        >
          <path stroke="#000000" d="M0 0h24v24H0z" fill="black" />
          <motion.path
            d="M5 12l14 0"
            initial={{
              strokeDasharray: "50%",
