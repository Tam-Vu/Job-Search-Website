...
export const professionalPosition = [
  ...
  {
    key: "regional_sales_manager",
    name: "Quản lý bán hàng khu vực",
    jobs: "sales_manager",
    jobField: "business_sales",
  },
  {
    key: "national_sales_manager",
    name: "Quản lý bán hàng quốc gia",
    jobs: "sales_manager",
    jobField: "business_sales",
  },
  {
    key: "sales_operations_manager",
    name: "Quản lý vận hành bán hàng",
    jobs: "sales_manager",
    jobField: "business_sales",
  },
  {
    key: "sales_strategy_manager",
    name: "Quản lý chiến lược bán hàng",
    jobs: "sales_manager",
    jobField: "business_sales",
  },
  { key: "seo_specialist", name: "Chuyên viên SEO", jobs: "digital_marketing", jobField: "marketing_pr_advertising" },
  {
    ...
    jobs: "digital_marketing",
    jobField: "marketing_pr_advertising",
  },
  {
    key: "email_marketer",
    name: "Chuyên viên tiếp thị qua email",
    jobs: "digital_marketing",
    jobField: "marketing_pr_advertising",
  },
  ...
  },
  {
    ...
    jobs: "customer_service_rep",
    jobField: "customer_service_operations",
  },
  {
    key: "technical_support_agent",
    name: "Nhân viên hỗ trợ kỹ thuật",
    jobs: "customer_service_rep",
    jobField: "customer_service_operations",
  },
  {
    key: "customer_service_supervisor",
    name: "Giám sát dịch vụ khách hàng",
    jobs: "customer_service_rep",
    jobField: "customer_service_operations",
  },
  {
    key: "customer_feedback_specialist",
    name: "Chuyên viên phản hồi khách hàng",
    jobs: "customer_service_rep",
    jobField: "customer_service_operations",
  },
  {
    key: "inbound_agent",
    name: "Nhân viên gọi đến",
    jobs: "call_center_agent",
    jobField: "customer_service_operations",
  },
  {
    key: "outbound_agent",
    name: "Nhân viên gọi đi",
    jobs: "call_center_agent",
    jobField: "customer_service_operations",
  },
  {
    key: "call_center_supervisor",
    name: "Giám sát viên trung tâm cuộc gọi",
    jobs: "call_center_agent",
    jobField: "customer_service_operations",
  },
  {
    key: "call_center_trainer",
    name: "Đào tạo viên trung tâm cuộc gọi",
    jobs: "call_center_agent",
    jobField: "customer_service_operations",
  },
  {
    key: "residential_agent",
    name: "Nhân viên bất động sản nhà ở",
    jobs: "real_estate_agent",
    jobField: "real_estate_construction",
  },
  {
    key: "commercial_agent",
    name: "Nhân viên bất động sản thương mại",
    jobs: "real_estate_agent",
    jobField: "real_estate_construction",
  },
  {
  ...
  {
    key: "site_manager",
    name: "Giám đốc công trường",
    jobs: "construction_manager",
    jobField: "real_estate_construction",
  },
  {
    key: "construction_supervisor",
  ...
  {
    key: "safety_officer",
    name: "Nhân viên an toàn xây dựng",
    jobs: "construction_manager",
    jobField: "real_estate_construction",
  },
  { key: "structural_engineer", name: "Kỹ sư kết cấu", jobs: "civil_engineer", jobField: "real_estate_construction" },
  {
    key: "geotechnical_engineer",
    name: "Kỹ sư địa kỹ thuật",
    jobs: "civil_engineer",
    jobField: "real_estate_construction",
  },
  {
    key: "transportation_engineer",
    name: "Kỹ sư giao thông",
    jobs: "civil_engineer",
    jobField: "real_estate_construction",
  },
  {
  ...
  { key: "academic_advisor", name: "Cố vấn học thuật", jobs: "administrator", jobField: "education" },
  {
    ...
    name: "Điều phối viên chương trình giảng dạy",
    jobs: "administrator",
    jobField: "education",
  },
  { key: "front_office_manager", name: "Quản lý lễ tân", jobs: "hotel_manager", jobField: "hospitality_service" },
  {
    ...
    name: "Quản lý bộ phận dọn phòng",
    jobs: "hotel_manager",
    jobField: "hospitality_service",
  },
  {
    key: "food_beverage_manager",
    name: "Quản lý thực phẩm và đồ uống",
    jobs: "hotel_manager",
    jobField: "hospitality_service",
  },
  ...
  {
    key: "catering_manager",
    name: "Quản lý dịch vụ ăn uống",
    jobs: "restaurant_manager",
    jobField: "hospitality_service",
  },
