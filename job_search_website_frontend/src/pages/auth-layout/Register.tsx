...
const formSchema = z.object({
  fullname: z.string().min(1, "Vui lòng điền vào chỗ trống"),
...
export const SignupForm = () => {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <div className="z-30 mx-auto my-auto h-[600px] w-full max-w-2xl rounded-none bg-white p-4 shadow-input dark:bg-black md:rounded-2xl md:p-8">
