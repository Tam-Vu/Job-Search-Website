...
export const Company = () => {
  return (
    <div className="flex h-full w-screen flex-col gap-6 bg-background px-[106px]">
      <div className="relative mt-5 max-h-[600px] w-full rounded-xl">
        <img
          src={CompanyDefault}
        ...
        <div className="flex h-full justify-center rounded-bl-xl rounded-br-xl bg-companyCover py-[30px]">
          <div className="flex max-w-[622px] flex-col items-center">
            <span className="text-wrap text-xl font-semibold text-white">
      ...
      <div className="flex w-full gap-[30px]">
        <div className="mb-6 flex h-full max-w-[750px] flex-col rounded-xl bg-white">
          ...
          <div className="m-5 text-sm text-black">
            CRC SPORTS – Nhà bán lẻ & phân phối thương hiệu các mặt hàng về thể thao hàng đầu tại Thái Lan và Việt Nam.
            Được thành lập tại Thái Lan vào năm 1997 với tên gọi ban đầu SuperSports. SuperSports Việt Nam là một hệ
            thống thuộc tập đoàn Central Retail hoạt động theo hai hình thức bán lẻ chính: Cửa hàng bán lẻ đồ thể thao
            của các thương hiệu khác nhau có tên là “SuperSports” & Cửa hàng chuyên biệt thương hiệu như Crocs hay New
            Balance. Sở hữu hơn 1200 địa điểm phân phối với hơn 20 thương hiệu thể thao chính thức khác nhau trên khắp
            thế giới như Crocs, New Balance, Fila, Umbro, Adidas, Nike,... SuperSports mang đến rất nhiều lựa chọn về
            giày dép và quần áo, máy tập thể dục và phụ kiện thể thao mang đến sản phẩm chất lượng tốt nhất cho các tín
            đồ đam mê thể thao tại Việt Nam. Cửa hàng bán lẻ: SuperSports, Crocs, New Balance, Fila và Skechers. Nhà
            phân phối: Crocs, Fila, Kambukka, Liverpool FC, PTP Fitness, New Balance, Speedo, Skechers, Under Armour và
            Zoggs
          </div>
        </div>
