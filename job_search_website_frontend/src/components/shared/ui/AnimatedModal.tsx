...
export const ModalContent = ({ children, className }: { children: ReactNode; className?: string }) => {
  return <div className={cn("flex flex-1 flex-col md:p-5 md:pt-12", className)}>{children}</div>
}
...
const CloseIcon = () => {
  ...
  return (
    <button
      ...
      className="hover-visible:outline-none group absolute right-4 top-4 border-0 bg-white outline-none focus-visible:outline-none"
    >
      <svg
