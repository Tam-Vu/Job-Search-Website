...
const FormElementsSidebar = () => {
  return (
    <div>
      <p className="text-black">Drag and drop elements</p>
      <Root className="my-2" />
      <div className="grid grid-cols-1 place-items-center gap-6 md:grid-cols-2">
        <p className="col-span-1 my-2 place-self-start text-sm text-black md:col-span-2">Layout Elements</p>
        ...
        <p className="col-span-1 my-2 place-self-start text-sm text-black md:col-span-2">Form Elements</p>
