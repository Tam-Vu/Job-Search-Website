...
class QuizController {
  ...
  getQuizAssignment = async (req, res) => {
    try {
      ...
      const employeeId = req.user.employeeId;
      const response = await quizService.getQuizAssignment(
        assignmentId,
        employeeId
      );
      return res.status(200).json(response);
  ...
  getQuizResultDetails = async (req, res) => {
    try {
      ...
      const response = await quizService.getQuizResultDetails(
        assignmentId,
        userRole,
        userId
      );
  ...
  getEmployeesForQuizAssignment = async (req, res) => {
    try {
      ...
      const response = await quizService.getEmployeesForQuizAssignment(
        quizId,
        employerId,
        search
      );
