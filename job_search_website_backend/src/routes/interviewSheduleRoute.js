...
const interviewScheduleRoute = (app) => {
  router.post(
    ...
    InterviewScheduleController.createInterviewShedule,
  );
  // router.put("/update/:interviewScheduleId", InterviewScheduleController.updateInterviewSchedule);
  router.patch(
    "/complete/:interviewScheduleId",
    InterviewScheduleController.completeInterviewShedule,
  );
  router.patch(
    "/cancel/:interviewScheduleId",
    InterviewScheduleController.cancelInterviewShedule,
  );
  router.get(
    "/my-interview",
    checkUserJwt,
    InterviewScheduleController.getMyInterviewSchedule,
  );
  router.get(
    "/my-interview-recuiter",
    checkUserJwt,
    InterviewScheduleController.getAllInterviewScheduleByEmployerId,
  );
