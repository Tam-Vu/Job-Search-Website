...
const quizRoute = (app) => {
  ...
  router.post(
    '/online-interview',
    QuizController.sendOnlineInterviewScheduleEmail
  );
  ...
  router.get(
    ...
    checkUserJwt,
    QuizController.getAllEmployeesForAssignment
  );
  ...
  router.get(
    '/:quizId/employee-results',
    checkUserJwt,
    QuizController.getEmployeeQuizResults
  );
  ...
  router.get(
    '/:quizId/assignments',
    checkUserJwt,
    QuizController.getQuizAssignmentsByQuizId
  );
  ...
  router.get(
    '/assigned/employee',
    checkUserJwt,
    QuizController.getAssignedQuizzes
  );
  ...
  router.get(
    ...
    checkUserJwt,
    QuizController.getQuizAssignment
  );

  // Submit quiz answers
  router.post(
    '/assignments/:quizId/submit',
    checkUserJwt,
  ...
  router.get(
    '/my-answers/:quizId',
    checkUserJwt,
    QuizController.getEmployeeQuizAnswers
  );

  // Employer route - Get detailed answers from a specific assignment
  router.get(
    '/detailed-answers/:assignmentId',
    checkUserJwt,
    QuizController.getDetailedQuizAnswers
  );
  ...
  router.get(
    ...
    checkUserJwt,
    QuizController.getQuizResultDetails
  );
